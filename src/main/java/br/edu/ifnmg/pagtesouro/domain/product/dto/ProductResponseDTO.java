 ...
 * <p>
 * **Conceito no TCC:**
 * Modela a exibição legível de itens cobráveis do catálogo acadêmico (ex: guias de recolhimento de biblioteca, tickets,
 ...
 * @param category Categoria de enquadramento estrutural do serviço (ex: TICKET, BIBLIOTECA, OUTROS)
 *
